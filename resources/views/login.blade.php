...
<head>
    ...
    <style>
        ...
        .welcome-text, .center-text, .bottom-text {
            position: absolute;
            left: 50%;
        ...
        .welcome-text { top: 10%; font-family: Alkatra; }
        .center-text { top: 55%; font-size: 3em; font-family: 'JYZ', serif; }
        .bottom-text { bottom: 15%; color: #F2D0A7; font-family: 'Dancing Script', cursive; font-size: 1rem; }
        ...
        @media (max-width: 768px) {
            ...
            .bottom-text { font-size: 0.875rem; }
            .footer-buttons { bottom: 5px; right: 5px; flex-direction: row; gap: 5px; }
            .footer-buttons button, .footer-buttons a { font-size: 0.625rem; padding: 0.25rem 0.5rem; }
        }
    </style>
</head>
<body class="bg-gradient-to-r from-[#404040] via-[#262626] to-[#59554D] flex items-center justify-center min-h-screen p-4">
    <div class="bg-[#262626] p-4 sm:p-8 rounded-lg shadow-2xl w-full max-w-4xl animate-slideIn flex flex-col md:flex-row">
        <div class="w-full md:w-1/2 p-8 bg-[#59554D] rounded-t-lg md:rounded-tl-lg md:rounded-bl-lg md:rounded-t-none hidden md:block">
            <div class="image-container h-64 md:h-full">
                <img src="{{ asset('img/b.jpg') }}" alt="Imagen Lateral" class="shadow-lg">
                <div class="welcome-text">
                    <h2 class="text-2xl md:text-3xl">Bienvenido</h2>
                </div>
        ...
        <div class="w-full md:w-1/2 p-8 bg-[#262626] rounded-b-lg md:rounded-r-lg md:rounded-b-none flex flex-col justify-center">
            <div class="flex justify-center mb-6">
                <img src="{{ asset('/img/logo-mov.gif') }}" alt="Logo" width="150" id="logo">
            </div>
            <form action="{{ route('ingresar', ['id' => $escuela->id ?? null]) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="escuela" name="escuela" value="{{ $escuela->nombre ?? 'Escuela no encontrada' }}" readonly
                ...
                <div class="mb-5">
                    ...
                    <div class="flex items-center">
                        ...
                        <button type="button" onclick="togglePasswordVisibility()" class="ml-4 text-[#A69177] focus:outline-none transition duration-500 transform hover:scale-110">
                            <svg id="togglePasswordIcon" class="w-6 h-6 transition-transform duration-500 ease-in-out" fill="currentColor" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                ...
                html: `
                    <p>Este inicio de sesión es único para cada escuela. Si no es el correcto, por favor, <a href="https://api.whatsapp.com/send?phone=+9221647818&text=El%20inicio%20de%20sesi%C3%B3n%20no%20es%20el%20asignado%20a%20mi%20escuela" target="_blank" class="text-green-500 underline">contáctenos</a>.</p>
                    <p class="mt-4">Si es correcto, ingrese su teléfono (10 dígitos) y una contraseña (4 dígitos). Si no está registrado, el sistema creará su perfil automáticamente.</p>
                `,
                icon: 'info',
            ...
            form.addEventListener('submit', function(e) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        handleErrors(data.message, data.errorType, formData);
                    }
                })
                .catch(error => {
        ...
        function handleErrors(message, errorType, formData) {
        ...
        function registerUser(formData) {
            ...
            .then(data => {
                if (data.success) {
                    window.location.href = data.redirect; // Redirigir al dashboard o la página que corresponda
                } else {
