...
class modelosGrupalesCuadros extends Controller
{
    //-----------------------------------------------------------------

    // PAQUETES DE CUADRO GRUPAL -------------

    public function verGrupal()
    {
        // Filtrar los datps con status 0 o 1
        $color = Color::where('tipo', 'grupal')->whereIn('status', [0, 1])->get();
        $modelo = Modelo::where('tipo', 'grupal')->whereIn('status', [0, 1])->get();
        $modelosGrupos = ModeloFotoGrupo::where('tipo', 'grupal')->whereIn('status', [0, 1])->get();

        return view('Jyz/cuadroGrupal', compact('color', 'modelo', 'modelosGrupos'));
    }
    ...
    public function agregarColores(Request $request)
    {
        ...
        return redirect('/grupal#colores');
    }
    ...
    public function agregarModelos(Request $request)
    {
        ...
        // Redirigir a la vista de paquetes u otra vista deseada
        return redirect('/grupal#modelos-marcos');
    }
    ...
    public function agregarModelosCuadrosGrupo(Request $request)
    {
        ...
        return redirect('/grupal#modelos-cuadros-grupo'); // Asegúrate de que la redirección sea hacia una ruta válida
    }
